                                   ...
                                   <div class="card-body">
                                       <div class="media">
                                           ...
                                           <div class="media-body text-white">
                                               <h6 class="">Welcome to the client signup screen</h6>
                           ...
                           <div class="card border-0 text-center mb-3 overflow-hidden" style=" box-shadow:1px 2px 2px 2px">
                               <div class="card-body position-relative p-0">
                                   <a href="javascript:void(0);" class="h-150 position-relative overflow-hidden d-block">
                                       <div class="background" style="background-image: url(&quot;../../assets/img/banner10.jpg&quot;);">
                                           <img src="../../assets/img/banner10.jpg" alt="" style="display: none; object-fit: fill;" >
                                       </div>
                                   </a>
                               </div>
                               <div class="card-footer">
                                   <form autocomplete="off" method="post" action="../../controllers/signup/client.php" enctype="multipart/form-data">
                                       <div class="form-group">
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                          ...
                                          <div class="form-group">
                                              <label >Refered By (Referer ID)</label>
                                              <input type="text" id="referer" name="referer" class="form-control form-control-lg border-1" placeholder="Refered By" required >
                                          </div>


                                          <label >Password</label>
                                          <div class="input-group mb-3">
                                             <input type="password" id="clientpassword" name="clientpassword" class="form-control form-control-lg border-1" placeholder="Password" aria-label="Password" onkeyup="checknewpass('clientpassword','clientpassword2','pwd_error');" required>
                                              <div class="input-group-append">
                                                <button class="btn btn-outline-secondary" type="button" onclick="show_hide_password('clientpassword');"><i class="fa fa-eye"></i></button>
                                              </div>
                                          </div>
                                          ...
                                          <div class="input-group mb-3">
                                             <input type="password" id="clientpassword2" name="clientpassword2" class="form-control form-control-lg border-1" placeholder="Confirm Password" onkeyup="checknewpass('clientpassword','clientpassword2','pwd_error');" required>
                                              <div class="input-group-append">
                                                <button class="btn btn-outline-secondary" type="button" onclick="show_hide_password('clientpassword2');"><i class="fa fa-eye"></i></button>
                                              </div>
                                          </div>
