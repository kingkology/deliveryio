                                   ...
                                   <div class="card-body">
                                       <div class="media">
                                           ...
                                           <div class="media-body text-white">
                                               <h6 class="">Welcome to the client login screen</h6>
                                               <p class="text-mute">Please enter credentials to login</p>
                                           </div>
                                           <a class="btn btn-light shadow-sm btn-44 " href="main.html" >
                       ...
                       <div class="col-sm-12 col-md-6 col-lg-6" >
                           <div class="card border-0 text-center mb-3 overflow-hidden" style=" box-shadow:1px 2px 2px 2px">
                               ...
                               <div class="card-footer">
                                   <form autocomplete="off" method="post" action="../../controllers/clients/login.php" enctype="multipart/form-data">
                                       <div class="form-group">
                                            <label >Telephone/ID</label>
                                            <input type="text" id="clientid" name="clientid" class="form-control form-control-lg border-1" placeholder="Telephone/ID" required autofocus="">
                                        </div>

                                        <div class="form-group">
                                             <label >Password</label>
                                             <input type="password" id="clientpassword" name="clientpassword" class="form-control form-control-lg border-1" placeholder="Password" required>
                                         </div>

                                         <div class="mb-4">
                                            <button type="submit" class=" btn btn-md btn-default default-shadow ">Sign In <span class="ml-2 icon arrow_right"></span></button>
                                        </div>
