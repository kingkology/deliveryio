...
<head>
    ...
    <meta name="description" content="AKROTECH HTML delivery website . delivery UI UX, delivery theme, delivery HTML, delivery template, delivery website, delivery pwa template.">
            ...
            <div class="container h-100 text-white">
                <div class="row h-100 h-sm-auto">
                    <div class="col-12 col-md-8 col-lg-5 col-xl-4 mx-auto align-self-center text-center">
                        ...
                        <br>
                        <br>
                        <h5 class="font-weight-light mb-1 text-mute">Welcome ,</h5>
                        ...
                        <div class="mb-4">
                            <a href="index.php" class=" btn btn-lg btn-default default-shadow btn-block <?php echo $christmas; ?>">Sign In <span class="ml-2 icon arrow_right"></span></a>
                        </div>
                        <div class="mb-4">
